...
void *handleClient(void *arg) {
    ...
    // Assume clientIdentifier was passed in with the socket as part of the argument
    std::string clientIdentifier = "client_identifier_placeholder";  // Modify to pass correct identifier
